...
- Mistral streaming (`/mistral/v1/chat/completions` with `stream: true`): stream tool calls whole with complete arguments in a shared delta rather than OpenAI-style argument fragmentation.
